...
```{r}
LBPdata %>% ggplot(aes(x = STARTDATE))+
  geom_histogram()
```
...
<br/>
  ...
  addPolygons(data = fire.dissolve, color = '#ff7f00', group = "2009 Bushfires") %>%
  addPolygons(data = logging.dissolve, color = '#999999', opacity = 0.4, group = "Historic Logging") %>%
  addPolygons(data = TRP.dissolve, color = '#35978f', group = "Timber Release Plan 2017") %>%
  addPolygons(data = Approved_TRP_2019, color = '#003c30', group = "Timber Release Plan 2019") %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Our Impact","Leadbeater's Possum", "200 m Buffer", "1 km Recommended Buffer", "Yellow-bellied Glider", "2009 Bushfires", "Historic Logging", "Timber Release Plan 2017", "Timber Release Plan 2019", "Greater Glider", "Tree Geebung", "Central Highlands RFA"),
    options = layersControlOptions(collapsed = FALSE)
  )
LBPmap <- LBPmap %>% hideGroup(c("Leadbeater's Possum", "200 m Buffer", "1 km Recommended Buffer", "Yellow-bellied Glider", "2009 Bushfires", "Historic Logging", "Timber Release Plan 2017", "Tree Geebung"))
